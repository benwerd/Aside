        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2 edit-pane">
                ...
                if (empty($vars['object']->_id)) {
                    ...
                    ?>
                        <h4><?php echo \Idno\Core\Idno::site()->language()->_('New Aside'); ?></h4>
                    <?php

                } else {

                    ?>
                        <h4><?php echo \Idno\Core\Idno::site()->language()->_('Edit Aside'); ?></h4>
                    <?php
            ...
            <div id="inreplyto">
                ...
                <p class="button-bar ">
                    ...
                    <?php echo \Idno\Core\Idno::site()->actions()->signForm('/aside/edit') ?>
